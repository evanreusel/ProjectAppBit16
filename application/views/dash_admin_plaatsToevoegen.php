...
?>
    <table class="table">
        ...
        foreach ($plaatsen as $plaats) {
            ...
            echo '<button type="button" class="verwijder btn btn-danger btn-round" data-toggle="modal" data-target="#taakModal" value="Plaats/verwijder/"' . $plaats->id . '" title="Druk hier om deze locatie te verwijderen">Verwijderen</button></td></tr>';
        }
